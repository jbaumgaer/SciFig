...
class LayoutUIFactory:
    ...
    def _create_parameter_line_edit(
        ...
        line_edit.editingFinished.connect(
            partial(
                self._handle_line_edit_change, layout_controller, param_name, line_edit
            )
        )
        return line_edit
    ...
    def build_layout_controls(
        ...
        self.logger.debug(
            f"Building layout controls for UI selected mode: {ui_mode.value}"
        )
    ...
    def _build_free_form_controls(
        ...
        # Align Left
        align_layout.addWidget(
            self._create_icon_button(
                "properties.alignment.align_horizontal_left",
                "Align Left",
                lambda: layout_controller.align_selected_plots("left"),
                container,
                "btn_align_left",
            )
        )
        ...
        align_layout.addWidget(
            self._create_icon_button(
                ...
                "Align Horizontal Center",
                lambda: layout_controller.align_selected_plots("h_center"),
                container,
                "btn_align_h_center",
            )
        )
        ...
        align_layout.addWidget(
            self._create_icon_button(
                ...
                "Align Right",
                lambda: layout_controller.align_selected_plots("right"),
                container,
                "btn_align_right",
            )
        )
        ...
        align_layout.addWidget(
            self._create_icon_button(
                ...
                "Align Top",
                lambda: layout_controller.align_selected_plots("top"),
                container,
                "btn_align_top",
            )
        )
        ...
        align_layout.addWidget(
            self._create_icon_button(
                ...
                "Align Vertical Center",
                lambda: layout_controller.align_selected_plots("v_center"),
                container,
                "btn_align_v_center",
            )
        )
        ...
        align_layout.addWidget(
            self._create_icon_button(
                ...
                "Align Bottom",
                lambda: layout_controller.align_selected_plots("bottom"),
                container,
                "btn_align_bottom",
            )
        )
        ...
        distribute_layout.addWidget(
            self._create_icon_button(
                "properties.distribute.horizontal_distribute",
                "Distribute Horizontally",
                lambda: layout_controller.distribute_selected_plots("horizontal"),
                container,
                "btn_distribute_h",
            )
        )
        ...
        distribute_layout.addWidget(
            self._create_icon_button(
                ...
                "Distribute Vertically",
                lambda: layout_controller.distribute_selected_plots("vertical"),
                container,
                "btn_distribute_v",
            )
        )
    ...
    def _build_grid_layout_controls(
        ...
        line_rows = self._create_parameter_line_edit(
            "rows",
            current_grid_config.rows if current_grid_config else None,
            QIntValidator(1, 99),
            container,
            layout_controller,
        )
        ...
        # Columns
        line_cols = self._create_parameter_line_edit(
            "cols",
            current_grid_config.cols if current_grid_config else None,
            QIntValidator(1, 99),
            container,
            layout_controller,
        )
        ...
        # Granular Margins
        line_margin_top = self._create_parameter_line_edit(
            "margin_top",
            current_grid_config.margins.top if current_grid_config else None,
            None,
            container,
            layout_controller,
        )
        ...
        line_margin_bottom = self._create_parameter_line_edit(
            "margin_bottom",
            current_grid_config.margins.bottom if current_grid_config else None,
            None,
            container,
            layout_controller,
        )
        ...
        line_margin_left = self._create_parameter_line_edit(
            "margin_left",
            current_grid_config.margins.left if current_grid_config else None,
            None,
            container,
            layout_controller,
        )
        ...
        line_margin_right = self._create_parameter_line_edit(
            "margin_right",
            current_grid_config.margins.right if current_grid_config else None,
            None,
            container,
            layout_controller,
        )
        ...
        line_hspace = self._create_parameter_line_edit(
            ...
            container,
            layout_controller,
            placeholder_text="e.g., 0.1, 0.2",
            is_list_param=True,
        )
        form_layout.addRow("H-Space (csv):", line_hspace)

        line_wspace = self._create_parameter_line_edit(
            "wspace",
            current_grid_config.gutters.wspace if current_grid_config else None,
            None,
            container,
            layout_controller,
            placeholder_text="e.g., 0.1, 0.2",
    ...
    def _handle_line_edit_change(
        self, layout_controller: LayoutController, param_name: str, line_edit: QLineEdit
    ):
                ...
                if current_grid_config is not None:
                    if param_name.startswith("margin"):
                        if param_name == "margin_top":
                            line_edit.setText(str(current_grid_config.margins.top))
                        elif param_name == "margin_bottom":
                            line_edit.setText(str(current_grid_config.margins.bottom))
                        elif param_name == "margin_left":
                            line_edit.setText(str(current_grid_config.margins.left))
                        elif param_name == "margin_right":
                            line_edit.setText(str(current_grid_config.margins.right))
                        ...
                        line_edit.setText(
                            ", ".join(map(str, current_grid_config.gutters.hspace))
                        )
        ...
        self.logger.debug(
            f"LayoutUIFactory: Processing change for {param_name}. Value: {value_to_pass}"
        )
