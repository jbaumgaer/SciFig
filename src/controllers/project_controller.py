...
class ProjectController(QObject):
    def __init__(self, model: ApplicationModel, command_manager: CommandManager, config_service: ConfigService, layout_manager: LayoutManager):
        super().__init__()
        self.model = model
    ...
    def create_new_layout(self, parent=None): # Parent added for QFileDialog consistency
        """
            ...
            if isinstance(new_slot_node, PlotNode):
                if old_plot_index < len(existing_plot_states):
                    ...
                    if new_slot_node.plot_properties:
                        ...
                        old_plot_type = old_plot_state["plot_properties_dict"].get("plot_type", "line")
