...
def test_renderer_switches_strategy(mock_scatter_class, mock_line_class, plot_node, mock_layout_manager, mock_application_model):
    """
    ...
    renderer = Renderer(layout_manager=mock_layout_manager, application_model=mock_application_model)
    ...
    mock_layout_manager.get_current_layout_geometries.return_value = {plot_node.id: plot_node.geometry}

    # --- Test 1: Verify Line Plot Strategy is Called ---
    plot_node.plot_properties.plot_type = PlotType.LINE

    # 2. Act
    renderer.render(mock_figure, mock_application_model.scene_root, mock_application_model.selection)
...
def test_renderer_calls_correct_render_function_for_node_type(mock_layout_manager, mock_application_model):
    """
...
def test_renderer_render_free_mode(mock_layout_manager, mock_application_model, plot_node):
    """
...
def test_renderer_render_grid_mode(mock_layout_manager, mock_application_model, plot_node):
    """
