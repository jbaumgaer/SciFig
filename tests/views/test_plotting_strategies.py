...
def test_line_plot_strategy(sample_data):
    ...
    pd.testing.assert_series_equal(call_args_1[0][0], sample_data[x_col], check_names=False)
    pd.testing.assert_series_equal(call_args_1[0][1], sample_data[y_cols[0]], check_names=False)
