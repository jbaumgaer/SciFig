...
def integration_menu_bar_builder(
    real_project_controller, real_layout_controller, real_command_manager
):
...
def real_project_controller():
    ...
    controller = ProjectController(
        mock_app_model, mock_command_manager, mock_config_service, mock_layout_manager
    )
...
def test_file_menu_actions_trigger_project_controller_methods(
    integration_menu_bar_builder, real_project_controller, qapp, qtbot
):
    """
...
def test_edit_menu_actions_trigger_command_manager_methods(
    integration_menu_bar_builder, real_command_manager, qapp, qtbot, mocker
):
    """
...
def test_open_recent_projects_menu_updates(
    integration_menu_bar_builder, real_project_controller, qapp, qtbot
):
    """
    ...
    # Change recent files
    updated_files = [
        "/path/to/new_file1.project",
        "/path/to/new_file2.project",
        "/path/to/new_file3.project",
    ]
