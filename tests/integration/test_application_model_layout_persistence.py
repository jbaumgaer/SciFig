...
from src.models.layout.layout_config import GridConfig, FreeConfig, Margins, Gutters


def test_application_model_grid_config_persistence(real_application_model, mock_config_service, tmp_path: Path):
    """
    ...
    assert serialized_data["layout_config"]["margins"]["left"] == original_grid_config.margins.left
...
def test_application_model_free_config_persistence(real_application_model, mock_config_service, tmp_path: Path):
    """
